...
Jogo educativo de educação financeira para crianças surdas, algumas com deficiência intelectual. Será projetado em sala, com intérprete de Libras, e controlado pelo apresentador (teclado) ou por crianças (toque na tela). O protótipo funcional está em `./atividades-educacao-financeira.html`. Ele é a fonte da verdade para comportamento, fluxo, textos, cores e layout. Não mude a mecânica, apenas profissionalize a entrega.
